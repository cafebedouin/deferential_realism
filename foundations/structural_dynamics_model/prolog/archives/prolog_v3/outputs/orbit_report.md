...
*Generated: corpus-wide orbit signature analysis via dirac_classification:gauge_orbit/2*

## Summary

- **Constraints analyzed**: 1150
- **Orbit families**: 21
- **Single-type families** (gauge-invariant): 5
- **Multi-type families** (gauge-variant): 16
- **Largest family**: [rope,snare] (337 constraints)

## Family Inventory

Families sorted by population (largest first).

### `[rope,snare]` — 337 constraints
...
- `requirement_invasive_diabetes_testing`
...
### `[rope,tangled_rope]` — 270 constraints
...
### `[rope,snare,tangled_rope]` — 188 constraints
...
- `global_trade_externalities_neobiota`
- `goodharts_law`
...
- `noncentrosymmetric_asoc_coupling`
- `optimal_stopping_marriage`
- `p_vs_np`
- `pancreatic_cancer_lethality_v1`
- `pareto_principle`
- `plekha7_synaptic_pruning`
- `poincare_conjecture`
...
### `[piton]` — 74 constraints

*Gauge-invariant: ossified coordination from all perspectives*
...
### `[mountain,scaffold]` — 19 constraints
...
### `[scaffold,tangled_rope]` — 13 constraints
...
### `[naturalized,rope,snare]` — 9 constraints
...
- `pele_microreactor_deployment`
- `us_embargo_cuba`
- `verification_bottleneck`

### `[scaffold,snare,tangled_rope]` — 6 constraints
...
### `[naturalized,rope,tangled_rope]` — 5 constraints
...
### `[snare,tangled_rope]` — 3 constraints

*2-type orbit: [snare,tangled_rope]*

- `epstein_document_release_2026`
- `lethal_targeting_of_journalists`
- `private_credit_market_opacity`

### `[naturalized,snare,tangled_rope]` — 3 constraints
...
*Gauge-invariant: pure extraction from all perspectives*

- `horizon_liability_contract`
- `sm_addictive_design`

### `[piton,rope,tangled_rope]` — 2 constraints

*3-type orbit: [piton,rope,tangled_rope]*

- `ritual_transition_scaffold`
- `ship_of_theseus`

### `[naturalized,tangled_rope]` — 1 constraints
...
- **mountain**: appears in 3 families (147 constraints total)
- **naturalized**: appears in 5 families (23 constraints total)
- **piton**: appears in 3 families (80 constraints total)
- **rope**: appears in 10 families (852 constraints total)
- **scaffold**: appears in 4 families (61 constraints total)
- **snare**: appears in 9 families (576 constraints total)
- **tangled_rope**: appears in 11 families (523 constraints total)
...
5 orbit families contain unresolved types:
...
- **Gauge-invariant** (single type across all contexts): 261 constraints (22.7%)
- **Gauge-variant** (type changes with observer): 889 constraints (77.3%)
