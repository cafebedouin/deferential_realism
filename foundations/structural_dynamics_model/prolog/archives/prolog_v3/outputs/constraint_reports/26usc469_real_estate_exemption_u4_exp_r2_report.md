...
[SCENARIO MANAGER] Loading: testsets/26usc469_real_estate_exemption_u4_exp_r2.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: 26usc469_real_estate_exemption_u4_exp_r2...
  [BRIDGE] Derived metric extractiveness = 0.1 for 26usc469_real_estate_exemption_u4_exp_r2 from config default
  [BRIDGE] Derived metric suppression_requirement = 0.1 for 26usc469_real_estate_exemption_u4_exp_r2 from config default
  [BRIDGE] Derived metric theater_ratio = 0.0 for 26usc469_real_estate_exemption_u4_exp_r2 from config default
  [BRIDGE] Derived constraint_claim(26usc469_real_estate_exemption_u4_exp_r2, rope) from computed analytical classification
  [FIXED] Imputed 24 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: 26usc469_real_estate_exemption_u4_exp_r2

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: 26usc469_real_estate_exemption_u4_exp_r2 (0-10)
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  26usc469_real_estate_exemption_u4_exp_r2 (ε=0.10):
...
=== Logical Fingerprint: 26usc469_real_estate_exemption_u4_exp_r2 ===
...
[STRUCTURAL SIGNATURE ANALYSIS]
  26usc469_real_estate_exemption_u4_exp_r2: constructed_low_extraction (confidence: low)
    → CONSTRUCTED LOW-EXTRACTION signature for 26usc469_real_estate_exemption_u4_exp_r2: Enforcement present (suppression=0.10, resistance=0.50) but extraction is low (0.10). This is a rule-based coordination structure, not an extraction mechanism.
...
[OMEGA RESOLUTION SCENARIO GENERATION]
  ...
  ┌─ [policy_intent_vs_effect] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Distinguishing between the intended anti-shelter purpose and the actual effect of creating a protected investor class.
  │
  │  RESOLUTION STRATEGY:
