...
[SCENARIO MANAGER] Loading: testsets/noncentrosymmetric_asoc_coupling.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: noncentrosymmetric_asoc_coupling...
  [FIXED] Imputed 24 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: noncentrosymmetric_asoc_coupling

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: noncentrosymmetric_asoc_coupling (0-0)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX OK] noncentrosymmetric_asoc_coupling from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(universal)): declared=mountain, computed=mountain
  [INDEX OK] noncentrosymmetric_asoc_coupling from context(agent_power(institutional),time_horizon(generational),exit_options(analytical),spatial_scope(global)): declared=mountain, computed=mountain
  [INDEX OK] noncentrosymmetric_asoc_coupling from context(agent_power(powerful),time_horizon(biographical),exit_options(analytical),spatial_scope(national)): declared=mountain, computed=mountain
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  noncentrosymmetric_asoc_coupling (ε=0.08):
...
=== Logical Fingerprint: noncentrosymmetric_asoc_coupling ===
...
--- CORPUS DISTRIBUTION ---
  ...
  --- CONSTRAINT POSITIONING ---
    ...
    Boundary zone: mountain->rope (134 constraints share this boundary)
...
[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [severe]: type_1_false_summit detected for noncentrosymmetric_asoc_coupling

[ONTOLOGICAL FORENSIC AUDIT: FALSE MOUNTAINS]
  All mountains are structurally validated.

[STRUCTURAL SIGNATURE ANALYSIS]
  noncentrosymmetric_asoc_coupling: natural_law (confidence: low)
    → NATURAL LAW signature for noncentrosymmetric_asoc_coupling: Extreme inaccessibility (collapse=0.92) with minimal enforcement (suppression=0.02, resistance=0.08). No viable alternatives exist. This represents an inherent property of the system, not a coordination choice. Cannot be changed by policy.
