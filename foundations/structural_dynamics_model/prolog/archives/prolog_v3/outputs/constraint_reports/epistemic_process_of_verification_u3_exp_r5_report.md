...
[SCENARIO MANAGER] Loading: testsets/epistemic_process_of_verification_u3_exp_r5.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: epistemic_process_of_verification_u3_exp_r5...
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: epistemic_process_of_verification_u3_exp_r5

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: epistemic_process_of_verification_u3_exp_r5 (1950-2050)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX OK] epistemic_process_of_verification_u3_exp_r5 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(global)): declared=snare, computed=snare
  [INDEX OK] epistemic_process_of_verification_u3_exp_r5 from context(agent_power(institutional),time_horizon(generational),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=rope
  [INDEX MISMATCH] epistemic_process_of_verification_u3_exp_r5 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
  [INDEX MISMATCH] epistemic_process_of_verification_u3_exp_r5 from context(agent_power(organized),time_horizon(generational),exit_options(constrained),spatial_scope(national)): declared=tangled_rope, computed=naturalized
...
================================================================
  ...
  epistemic_process_of_verification_u3_exp_r5:
    [critical] extraction_accumulation
        Evidence: evidence(extraction_delta,1950,2020,0.35,0.55)
...
--- Terminal State Predictions ---
  epistemic_process_of_verification_u3_exp_r5 -> tangled_rope (confidence: low)
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  epistemic_process_of_verification_u3_exp_r5 (ε=0.55):
...
=== Logical Fingerprint: epistemic_process_of_verification_u3_exp_r5 ===
...
--- CONSTRAINT IDENTITY ---
    ...
    Tangled psi:      0.9982 (snare_leaning)
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_epistemic_process_of_verification_u3_exp_r5
    Severity Score:    0.675
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.4546 (borderline)
    Rival Type:       snare (P=0.5454)
    Margin:           -0.0908
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        -0.0908
  Entropy:       0.3846
  Distribution:  snare: 0.545, tangled_rope: 0.455, scaffold: 0.000
...
====================================================
Timeline:       1950 to 2050
Structural Pattern: stable
Confidence:     high

[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [informational]: perspectival_incoherence detected for epistemic_process_of_verification_u3_exp_r5

[STRUCTURAL SIGNATURE ANALYSIS]
  epistemic_process_of_verification_u3_exp_r5: false_ci_rope (confidence: high)
    → FALSE CI_ROPE signature for epistemic_process_of_verification_u3_exp_r5: Appears to be rope (indexed_rope_classification) but fails 4 Boltzmann structural test(s): [boltzmann_non_compliant(1.0,0.25),scope_variant([snare,tangled_rope]),excess_above_floor(0.53),nonsensical_coupling(0.5)]. Coupling score=1.0. This constraint is "coordination-washed" — it hides extraction behind low metrics, distributed enforcement, or behavioral defaults.
...
[MANDATROPHY GAP ANALYSIS]
  ...
  epistemic_process_of_verification_u3_exp_r5 (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.62 (high)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 2 resolution scenario(s):

  ┌─ [replication_cost_origin] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Whether the high cost of scientific replication is a natural limit or an institutional artifact.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [omega_extraction_blindness_epistemic_process_of_verification_u3_exp_r5] CONCEPTUAL CLARIFICATION
  │  Constraint: epistemic_process_of_verification_u3_exp_r5
  │  Gap: Constraint epistemic_process_of_verification_u3_exp_r5 appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from epistemic_process_of_verification_u3_exp_r5?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does epistemic_process_of_verification_u3_exp_r5 serve?
