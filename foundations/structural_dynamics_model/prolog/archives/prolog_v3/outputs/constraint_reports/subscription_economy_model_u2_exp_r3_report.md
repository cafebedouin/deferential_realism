...
[SCENARIO MANAGER] Loading: testsets/subscription_economy_model_u2_exp_r3.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: subscription_economy_model_u2_exp_r3...
  [FIXED] Imputed 24 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: subscription_economy_model_u2_exp_r3

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: subscription_economy_model_u2_exp_r3 (0-10)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX OK] subscription_economy_model_u2_exp_r3 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(national)): declared=snare, computed=snare
  [INDEX OK] subscription_economy_model_u2_exp_r3 from context(agent_power(institutional),time_horizon(biographical),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=rope
  [INDEX MISMATCH] subscription_economy_model_u2_exp_r3 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
...
================================================================
  ...
  subscription_economy_model_u2_exp_r3:
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  subscription_economy_model_u2_exp_r3 (ε=0.55):
...
=== Logical Fingerprint: subscription_economy_model_u2_exp_r3 ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_subscription_economy_model_u2_exp_r3
    Severity Score:    0.63
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.7626 (moderate)
    Rival Type:       snare (P=0.2374)
    Margin:           +0.5253
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        +0.5253
  Entropy:       0.3059
  Distribution:  tangled_rope: 0.763, snare: 0.237, scaffold: 0.000
...
[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [informational]: perspectival_incoherence detected for subscription_economy_model_u2_exp_r3

[STRUCTURAL SIGNATURE ANALYSIS]
  subscription_economy_model_u2_exp_r3: false_ci_rope (confidence: high)
    → FALSE CI_ROPE signature for subscription_economy_model_u2_exp_r3: Appears to be rope (indexed_rope_classification) but fails 4 Boltzmann structural test(s): [boltzmann_non_compliant(1.0,0.25),scope_variant([snare,tangled_rope]),excess_above_floor(0.5),nonsensical_coupling(0.5)]. Coupling score=1.0. This constraint is "coordination-washed" — it hides extraction behind low metrics, distributed enforcement, or behavioral defaults.
...
[MANDATROPHY GAP ANALYSIS]
  ...
  subscription_economy_model_u2_exp_r3 (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.62 (high)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 1 resolution scenario(s):

  ┌─ [omega_extraction_blindness_subscription_economy_model_u2_exp_r3] CONCEPTUAL CLARIFICATION
  │  Constraint: subscription_economy_model_u2_exp_r3
  │  Gap: Constraint subscription_economy_model_u2_exp_r3 appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from subscription_economy_model_u2_exp_r3?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does subscription_economy_model_u2_exp_r3 serve?
