...
[SCENARIO MANAGER] Loading: testsets/epistemic_p_u3_exp_r2.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: epistemic_p_u3_exp_r2...
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: epistemic_p_u3_exp_r2

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: epistemic_p_u3_exp_r2 (1950-2025)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX OK] epistemic_p_u3_exp_r2 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(national)): declared=snare, computed=snare
  [INDEX OK] epistemic_p_u3_exp_r2 from context(agent_power(institutional),time_horizon(generational),exit_options(arbitrage),spatial_scope(continental)): declared=rope, computed=rope
  [INDEX MISMATCH] epistemic_p_u3_exp_r2 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
  [INDEX OK] epistemic_p_u3_exp_r2 from context(agent_power(moderate),time_horizon(biographical),exit_options(constrained),spatial_scope(national)): declared=tangled_rope, computed=tangled_rope
...
--- Terminal State Predictions ---
  epistemic_p_u3_exp_r2 -> tangled_rope (confidence: low)
...
=== Logical Fingerprint: epistemic_p_u3_exp_r2 ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_epistemic_p_u3_exp_r2
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.5103 (moderate)
    Rival Type:       snare (P=0.4897)
    Margin:           +0.0206
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        +0.0206
  Entropy:       0.3867
  Distribution:  tangled_rope: 0.510, snare: 0.490, scaffold: 0.000
...
--- CORPUS DISTRIBUTION ---
  ...
  --- CONSTRAINT POSITIONING ---
    ...
    Confidence band: moderate (15.6% of corpus in this band)
    Boundary zone: tangled_rope->snare (660 constraints share this boundary)
    Orbit Family ID:  F253
...
[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [informational]: perspectival_incoherence detected for epistemic_p_u3_exp_r2

[STRUCTURAL SIGNATURE ANALYSIS]
  epistemic_p_u3_exp_r2: false_ci_rope (confidence: high)
    → FALSE CI_ROPE signature for epistemic_p_u3_exp_r2: Appears to be rope (indexed_rope_classification) but fails 4 Boltzmann structural test(s): [boltzmann_non_compliant(1.0,0.25),scope_variant([snare,tangled_rope]),excess_above_floor(0.53),nonsensical_coupling(0.5)]. Coupling score=1.0. This constraint is "coordination-washed" — it hides extraction behind low metrics, distributed enforcement, or behavioral defaults.
    → Institutional beneficiary: standard_setting_institutions
...
[MANDATROPHY GAP ANALYSIS]
  ...
  epistemic_p_u3_exp_r2 (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.62 (high)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 2 resolution scenario(s):

  ┌─ [p_threshold_optimality] CONCEPTUAL CLARIFICATION
  │  Constraint: unknown
  │  Gap: The core ambiguity of whether a single epistemic threshold can be optimal or is always extractive.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [omega_extraction_blindness_epistemic_p_u3_exp_r2] CONCEPTUAL CLARIFICATION
  │  Constraint: epistemic_p_u3_exp_r2
  │  Gap: Constraint epistemic_p_u3_exp_r2 appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from epistemic_p_u3_exp_r2?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does epistemic_p_u3_exp_r2 serve?
