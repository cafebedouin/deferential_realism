...
[SCENARIO MANAGER] Loading: testsets/individual_vs_systemic_causation.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: individual_vs_systemic_causation...
  [FIXED] Imputed 24 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: individual_vs_systemic_causation

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: individual_vs_systemic_causation (0-10)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX OK] individual_vs_systemic_causation from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(regional)): declared=snare, computed=snare
  [INDEX OK] individual_vs_systemic_causation from context(agent_power(institutional),time_horizon(biographical),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=rope
  [INDEX MISMATCH] individual_vs_systemic_causation from context(agent_power(institutional),time_horizon(generational),exit_options(constrained),spatial_scope(national)): declared=tangled_rope, computed=naturalized
  [INDEX MISMATCH] individual_vs_systemic_causation from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  individual_vs_systemic_causation (ε=0.68):
...
=== Logical Fingerprint: individual_vs_systemic_causation ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_individual_vs_systemic_causation
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.1883 (borderline)
    Rival Type:       snare (P=0.8117)
    Margin:           -0.6234
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        -0.6234
  Entropy:       0.2700
  Distribution:  snare: 0.812, tangled_rope: 0.188
...
--- CORPUS DISTRIBUTION ---
  ...
  --- CONSTRAINT POSITIONING ---
    ...
    Confidence band: borderline (44.4% of corpus in this band)
    Boundary zone: tangled_rope->snare (635 constraints share this boundary)
    Orbit Family ID:  F292
...
[MANDATROPHY GAP ANALYSIS]
  ...
  individual_vs_systemic_causation (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.77 (high)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 1 resolution scenario(s):

  ┌─ [omega_extraction_blindness_individual_vs_systemic_causation] CONCEPTUAL CLARIFICATION
  │  Constraint: individual_vs_systemic_causation
  │  Gap: Constraint individual_vs_systemic_causation appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from individual_vs_systemic_causation?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does individual_vs_systemic_causation serve?
