...
[SCENARIO MANAGER] Loading: testsets/academic_peer_review_gatekeeping_u2_exp_r3.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: academic_peer_review_gatekeeping_u2_exp_r3...
  [FIXED] Imputed 24 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: academic_peer_review_gatekeeping_u2_exp_r3

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: academic_peer_review_gatekeeping_u2_exp_r3 (0-10)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX MISMATCH] academic_peer_review_gatekeeping_u2_exp_r3 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(global)): declared=snare, computed=tangled_rope
  [INDEX OK] academic_peer_review_gatekeeping_u2_exp_r3 from context(agent_power(institutional),time_horizon(generational),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=rope
  [INDEX MISMATCH] academic_peer_review_gatekeeping_u2_exp_r3 from context(agent_power(analytical),time_horizon(generational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
  [INDEX MISMATCH] academic_peer_review_gatekeeping_u2_exp_r3 from context(agent_power(organized),time_horizon(biographical),exit_options(constrained),spatial_scope(national)): declared=tangled_rope, computed=naturalized
...
================================================================
  ...
  academic_peer_review_gatekeeping_u2_exp_r3:
    [warning] purity_drift
        Evidence: evidence(current_purity,0.3125,decline_signals,[coupling_above_threshold(1.0),excess_above_floor(0.57)])
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  academic_peer_review_gatekeeping_u2_exp_r3 (ε=0.62):
...
=== Logical Fingerprint: academic_peer_review_gatekeeping_u2_exp_r3 ===
...
--- CONSTRAINT IDENTITY ---
    ...
    Tangled psi:      0.9986 (snare_leaning)
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_academic_peer_review_gatekeeping_u2_exp_r3
    Severity Score:    0.695
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.2672 (borderline)
    Rival Type:       snare (P=0.7328)
    Margin:           -0.4656
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        -0.4656
  Entropy:       0.3240
  Distribution:  snare: 0.733, tangled_rope: 0.267
...
[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [informational]: perspectival_incoherence detected for academic_peer_review_gatekeeping_u2_exp_r3

[STRUCTURAL SIGNATURE ANALYSIS]
  academic_peer_review_gatekeeping_u2_exp_r3: false_ci_rope (confidence: high)
    → FALSE CI_ROPE signature for academic_peer_review_gatekeeping_u2_exp_r3: Appears to be rope (indexed_rope_classification) but fails 4 Boltzmann structural test(s): [boltzmann_non_compliant(1.0,0.25),scope_variant([snare,tangled_rope]),excess_above_floor(0.57),nonsensical_coupling(0.5)]. Coupling score=1.0. This constraint is "coordination-washed" — it hides extraction behind low metrics, distributed enforcement, or behavioral defaults.
...
[MANDATROPHY GAP ANALYSIS]
  ...
  academic_peer_review_gatekeeping_u2_exp_r3 (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.35 (moderate)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 1 resolution scenario(s):

  ┌─ [omega_extraction_blindness_academic_peer_review_gatekeeping_u2_exp_r3] CONCEPTUAL CLARIFICATION
  │  Constraint: academic_peer_review_gatekeeping_u2_exp_r3
  │  Gap: Constraint academic_peer_review_gatekeeping_u2_exp_r3 appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from academic_peer_review_gatekeeping_u2_exp_r3?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does academic_peer_review_gatekeeping_u2_exp_r3 serve?
