...
[SCENARIO MANAGER] Loading: testsets/subscription_economy_model_u2_sed_r1.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: subscription_economy_model_u2_sed_r1...
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: subscription_economy_model_u2_sed_r1

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: subscription_economy_model_u2_sed_r1 (2010-2024)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX MISMATCH] subscription_economy_model_u2_sed_r1 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(national)): declared=snare, computed=tangled_rope
  [INDEX OK] subscription_economy_model_u2_sed_r1 from context(agent_power(institutional),time_horizon(generational),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=rope
  [INDEX MISMATCH] subscription_economy_model_u2_sed_r1 from context(agent_power(moderate),time_horizon(biographical),exit_options(constrained),spatial_scope(national)): declared=tangled_rope, computed=snare
  [INDEX MISMATCH] subscription_economy_model_u2_sed_r1 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
...
================================================================
  ...
  subscription_economy_model_u2_sed_r1:
...
--- Terminal State Predictions ---
  subscription_economy_model_u2_sed_r1 -> tangled_rope (confidence: low)
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  subscription_economy_model_u2_sed_r1 (ε=0.68):
...
=== Logical Fingerprint: subscription_economy_model_u2_sed_r1 ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_subscription_economy_model_u2_sed_r1
...
[MANDATROPHY GAP ANALYSIS]
  ...
  subscription_economy_model_u2_sed_r1 (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.38 (moderate)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 3 resolution scenario(s):

  ┌─ [subscription_necessity_vs_choice] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Whether the subscription model is a technical necessity or an extractive choice.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [consumer_inertia_quantification] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Quantifying the value extracted from consumer inertia vs. perceived service value.
  │
  │  RESOLUTION STRATEGY:
  │  1. Design measurement protocol for unknown
  │  2. Collect data from N=30+ real-world instances
  ...
  ┌─ [omega_extraction_blindness_subscription_economy_model_u2_sed_r1] CONCEPTUAL CLARIFICATION
  │  Constraint: subscription_economy_model_u2_sed_r1
  │  Gap: Constraint subscription_economy_model_u2_sed_r1 appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from subscription_economy_model_u2_sed_r1?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does subscription_economy_model_u2_sed_r1 serve?
