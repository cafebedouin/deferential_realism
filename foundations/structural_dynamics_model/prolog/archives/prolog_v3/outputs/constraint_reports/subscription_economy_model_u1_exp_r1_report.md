...
[SCENARIO MANAGER] Loading: testsets/subscription_economy_model_u1_exp_r1.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: subscription_economy_model_u1_exp_r1...
  [BRIDGE] Derived has_sunset_clause(subscription_economy_model_u1_exp_r1) from scaffold declaration
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: subscription_economy_model_u1_exp_r1

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: subscription_economy_model_u1_exp_r1 (2008-2023)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX OK] subscription_economy_model_u1_exp_r1 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(global)): declared=snare, computed=snare
  [INDEX MISMATCH] subscription_economy_model_u1_exp_r1 from context(agent_power(institutional),time_horizon(immediate),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=scaffold
  [INDEX MISMATCH] subscription_economy_model_u1_exp_r1 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
  [INDEX MISMATCH] subscription_economy_model_u1_exp_r1 from context(agent_power(organized),time_horizon(generational),exit_options(constrained),spatial_scope(national)): declared=scaffold, computed=naturalized
...
================================================================
  ...
  subscription_economy_model_u1_exp_r1:
    [critical] extraction_accumulation
        Evidence: evidence(extraction_delta,0,15,0.25,0.68)
...
--- Terminal State Predictions ---
  subscription_economy_model_u1_exp_r1 -> tangled_rope (confidence: low)
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  subscription_economy_model_u1_exp_r1 (ε=0.68):
...
=== Logical Fingerprint: subscription_economy_model_u1_exp_r1 ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_subscription_economy_model_u1_exp_r1
...
[MANDATROPHY GAP ANALYSIS]
  ...
  subscription_economy_model_u1_exp_r1 (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.77 (high)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 2 resolution scenario(s):

  ┌─ [subscription_value_vs_rent] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Distinguishing between fair service pricing and rent-seeking on a captured user base.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [omega_extraction_blindness_subscription_economy_model_u1_exp_r1] CONCEPTUAL CLARIFICATION
  │  Constraint: subscription_economy_model_u1_exp_r1
  │  Gap: Constraint subscription_economy_model_u1_exp_r1 appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from subscription_economy_model_u1_exp_r1?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does subscription_economy_model_u1_exp_r1 serve?
