...
--- PER-INDEX VALIDATION ---
  ...
  [INDEX MISMATCH] sovereignty_as_arbitrage from context(agent_power(institutional),time_horizon(generational),exit_options(trapped),spatial_scope(national)): declared=snare, computed=naturalized
