...
[SCENARIO MANAGER] Loading: testsets/policy_implementation_gap.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: policy_implementation_gap...
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: policy_implementation_gap

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: policy_implementation_gap (1990-2024)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX MISMATCH] policy_implementation_gap from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(national)): declared=snare, computed=tangled_rope
  [INDEX OK] policy_implementation_gap from context(agent_power(institutional),time_horizon(biographical),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=rope
  [INDEX MISMATCH] policy_implementation_gap from context(agent_power(institutional),time_horizon(generational),exit_options(constrained),spatial_scope(national)): declared=tangled_rope, computed=naturalized
  [INDEX OK] policy_implementation_gap from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=tangled_rope
...
================================================================
  ...
  policy_implementation_gap:
    [critical] extraction_accumulation
        Evidence: evidence(extraction_delta,1990,2024,0.3,0.48)
...
--- Terminal State Predictions ---
  policy_implementation_gap -> tangled_rope (confidence: low)
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  policy_implementation_gap (ε=0.48):
...
=== Logical Fingerprint: policy_implementation_gap ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_policy_implementation_gap
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.9007 (deep)
    Rival Type:       snare (P=0.0992)
    Margin:           +0.8015
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        +0.8015
  Entropy:       0.1807
  Distribution:  tangled_rope: 0.901, snare: 0.099, scaffold: 0.000
...
--- CORPUS DISTRIBUTION ---
  ...
  --- CONSTRAINT POSITIONING ---
    ...
    Boundary zone: tangled_rope->snare (635 constraints share this boundary)
    Orbit Family ID:  F371
...
====================================================
Timeline:       1990 to 2024
Structural Pattern: stable
Confidence:     high

[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [informational]: perspectival_incoherence detected for policy_implementation_gap

[STRUCTURAL SIGNATURE ANALYSIS]
  policy_implementation_gap: false_ci_rope (confidence: high)
    → FALSE CI_ROPE signature for policy_implementation_gap: Appears to be rope (indexed_rope_classification) but fails 3 Boltzmann structural test(s): [boltzmann_non_compliant(1.0,0.3),excess_above_floor(0.32999999999999996),nonsensical_coupling(0.16666666666666666)]. Coupling score=1.0. This constraint is "coordination-washed" — it hides extraction behind low metrics, distributed enforcement, or behavioral defaults.
    → Institutional beneficiary: status_quo_healthcare_systems
...
[MANDATROPHY GAP ANALYSIS]
  ...
  policy_implementation_gap (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.54 (high)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 2 resolution scenario(s):

  ┌─ [intent_vs_inertia] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Distinguishing between deliberate profit-seeking and emergent bureaucratic failure as the primary driver of the policy gap.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [omega_extraction_blindness_policy_implementation_gap] CONCEPTUAL CLARIFICATION
  │  Constraint: policy_implementation_gap
  │  Gap: Constraint policy_implementation_gap appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from policy_implementation_gap?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does policy_implementation_gap serve?
