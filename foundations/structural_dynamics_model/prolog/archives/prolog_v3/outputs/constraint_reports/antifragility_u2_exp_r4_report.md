...
[SCENARIO MANAGER] Loading: testsets/antifragility_u2_exp_r4.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: antifragility_u2_exp_r4...
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: antifragility_u2_exp_r4

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: antifragility_u2_exp_r4 (2012-2024)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX OK] antifragility_u2_exp_r4 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(national)): declared=snare, computed=snare
  [INDEX MISMATCH] antifragility_u2_exp_r4 from context(agent_power(moderate),time_horizon(biographical),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=snare
  [INDEX MISMATCH] antifragility_u2_exp_r4 from context(agent_power(institutional),time_horizon(generational),exit_options(constrained),spatial_scope(national)): declared=tangled_rope, computed=naturalized
  [INDEX MISMATCH] antifragility_u2_exp_r4 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
...
================================================================
  ...
  antifragility_u2_exp_r4:
    [warning] metric_substitution
        Evidence: evidence(theater_delta,2012,2024,0.1,0.55)
    [critical] extraction_accumulation
        Evidence: evidence(extraction_delta,2012,2024,0.4,0.75)
...
--- Terminal State Predictions ---
  antifragility_u2_exp_r4 -> tangled_rope (confidence: low)
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  antifragility_u2_exp_r4 (ε=0.75):
...
=== Logical Fingerprint: antifragility_u2_exp_r4 ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_perspectival_antifragility_u2_exp_r4
    Severity Score:    0.73
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.2228 (borderline)
    Rival Type:       snare (P=0.7772)
    Margin:           -0.5545
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        -0.5545
  Entropy:       0.2960
  Distribution:  snare: 0.777, tangled_rope: 0.223, piton: 0.000
...
[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [informational]: perspectival_incoherence detected for antifragility_u2_exp_r4

[STRUCTURAL SIGNATURE ANALYSIS]
  antifragility_u2_exp_r4: false_ci_rope (confidence: medium)
    → FALSE CI_ROPE signature for antifragility_u2_exp_r4: Appears to be rope (indexed_rope_classification) but fails 2 Boltzmann structural test(s): [boltzmann_non_compliant(0.75,0.3),excess_above_floor(0.6)]. Coupling score=0.75. This constraint is "coordination-washed" — it hides extraction behind low metrics, distributed enforcement, or behavioral defaults.
...
[MANDATROPHY GAP ANALYSIS]
  ...
  antifragility_u2_exp_r4 (snare vs tangled_rope):
    ! MANDATROPHY GAP: delta_chi = 0.85 (high)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 2 resolution scenario(s):

  ┌─ [intent_vs_emergence] CONCEPTUAL CLARIFICATION
  │  Constraint: unknown
  │  Gap: Distinguishing between predatory extraction and emergent functional properties of antifragile systems.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [omega_perspectival_antifragility_u2_exp_r4] CONCEPTUAL CLARIFICATION
  │  Constraint: antifragility_u2_exp_r4
  │  Gap: Constraint antifragility_u2_exp_r4 appears as snare to individuals but tangled_rope to institutions...
  │
  │  RESOLUTION STRATEGY:
  │  1. Map stakeholder perspectives:
  │     - Document how different actors perceive antifragility_u2_exp_r4
  │     - Identify source of divergence
  │  2. Gather evidence:
  │     - Empirical metrics (suppression, extraction, resistance)
  │     - Historical behavior patterns
