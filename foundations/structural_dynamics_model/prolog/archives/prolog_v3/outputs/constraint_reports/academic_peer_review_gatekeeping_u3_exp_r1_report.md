...
[SCENARIO MANAGER] Loading: testsets/academic_peer_review_gatekeeping_u3_exp_r1.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: academic_peer_review_gatekeeping_u3_exp_r1...
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: academic_peer_review_gatekeeping_u3_exp_r1

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: academic_peer_review_gatekeeping_u3_exp_r1 (1975-2025)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX MISMATCH] academic_peer_review_gatekeeping_u3_exp_r1 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(global)): declared=snare, computed=tangled_rope
  [INDEX OK] academic_peer_review_gatekeeping_u3_exp_r1 from context(agent_power(institutional),time_horizon(generational),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=rope
  [INDEX MISMATCH] academic_peer_review_gatekeeping_u3_exp_r1 from context(agent_power(institutional),time_horizon(generational),exit_options(constrained),spatial_scope(national)): declared=tangled_rope, computed=naturalized
  [INDEX MISMATCH] academic_peer_review_gatekeeping_u3_exp_r1 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
...
================================================================
  ...
  academic_peer_review_gatekeeping_u3_exp_r1:
    [warning] metric_substitution
        Evidence: evidence(theater_delta,1975,2025,0.25,0.6)
...
--- Terminal State Predictions ---
  academic_peer_review_gatekeeping_u3_exp_r1 -> tangled_rope (confidence: low)
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  academic_peer_review_gatekeeping_u3_exp_r1 (ε=0.78):
...
=== Logical Fingerprint: academic_peer_review_gatekeeping_u3_exp_r1 ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_academic_peer_review_gatekeeping_u3_exp_r1
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.0586 (borderline)
    Rival Type:       snare (P=0.9414)
    Margin:           -0.8829
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        -0.8829
  Entropy:       0.1246
  Distribution:  snare: 0.941, tangled_rope: 0.059, piton: 0.000
...
--- DIAGNOSTIC VERDICT ---
  ...
  Tensions (2):
    ...
    drift: critical_drift([drift(metric_substitution,evidence(theater_delta,1975,2025,0.25,0.6),warning),drift(extraction_accumulation,evidence(extraction_delta,1975,2025,0.3,0.78),critical),drift(coupling_drift,evidence(coupling_score,1.0,threshold,0.25,extraction_trend,increasing),critical),drift(purity_drift,evidence(current_purity,0.5,decline_signals,[extraction_rising,coupling_above_threshold(1.0),theater_rising,excess_above_floor(0.76)]),warning),drift(network_drift,evidence(drifting_neighbors,[contagion(academic_peer_review_gatekeeping,0.014062499999999999,[extraction_rising,coupling_above_threshold(1.0),theater_rising,excess_above_floor(0.7)]),contagion(academic_peer_review_gatekeeping_u2_exp_r1,0.056249999999999994,[coupling_above_threshold(1.0),excess_above_floor(0.63)]),contagion(academic_peer_review_gatekeeping_u2_exp_r2,0.056249999999999994,[extraction_rising,coupling_above_threshold(1.0),theater_rising,excess_above_floor(0.66)]),contagion(academic_peer_review_gatekeeping_u3_exp_r2,0.08437499999999999,[extraction_rising,coupling_above_threshold(1.0),theater_rising,excess_above_floor(0.66)]),contagion(academic_peer_review_gatekeeping_u4_exp_r1,0.08437499999999999,[coupling_above_threshold(1.0),excess_above_floor(0.63)]),contagion(academic_peer_review_gatekeeping_u4_exp_r2,0.08437499999999999,[extraction_rising,coupling_above_threshold(1.0),theater_rising,excess_above_floor(0.66)])],effective_purity,0.31015625,intrinsic_purity,0.5),critical)])
...
[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [informational]: perspectival_incoherence detected for academic_peer_review_gatekeeping_u3_exp_r1

[STRUCTURAL SIGNATURE ANALYSIS]
  academic_peer_review_gatekeeping_u3_exp_r1: false_ci_rope (confidence: medium)
    → FALSE CI_ROPE signature for academic_peer_review_gatekeeping_u3_exp_r1: Appears to be rope (indexed_rope_classification) but fails 2 Boltzmann structural test(s): [boltzmann_non_compliant(1.0,0.25),excess_above_floor(0.76)]. Coupling score=1.0. This constraint is "coordination-washed" — it hides extraction behind low metrics, distributed enforcement, or behavioral defaults.
...
[MANDATROPHY GAP ANALYSIS]
  ...
  academic_peer_review_gatekeeping_u3_exp_r1 (snare vs rope):
...
[OMEGA RESOLUTION SCENARIO GENERATION]
  ...
  │  Constraint: unknown
  │  Gap: Whether journal prestige is an essential coordination good or theatrical rent-seeking.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [omega_extraction_blindness_academic_peer_review_gatekeeping_u3_exp_r1] CONCEPTUAL CLARIFICATION
  │  Constraint: academic_peer_review_gatekeeping_u3_exp_r1
  │  Gap: Constraint academic_peer_review_gatekeeping_u3_exp_r1 appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from academic_peer_review_gatekeeping_u3_exp_r1?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does academic_peer_review_gatekeeping_u3_exp_r1 serve?
