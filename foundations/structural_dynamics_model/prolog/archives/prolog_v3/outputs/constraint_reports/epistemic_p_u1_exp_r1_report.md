...
[SCENARIO MANAGER] Loading: testsets/epistemic_p_u1_exp_r1.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: epistemic_p_u1_exp_r1...
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: epistemic_p_u1_exp_r1

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: epistemic_p_u1_exp_r1 (1955-2025)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX MISMATCH] epistemic_p_u1_exp_r1 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(global)): declared=snare, computed=tangled_rope
  [INDEX MISMATCH] epistemic_p_u1_exp_r1 from context(agent_power(powerful),time_horizon(biographical),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=tangled_rope
  [INDEX MISMATCH] epistemic_p_u1_exp_r1 from context(agent_power(institutional),time_horizon(immediate),exit_options(constrained),spatial_scope(global)): declared=tangled_rope, computed=naturalized
  [INDEX MISMATCH] epistemic_p_u1_exp_r1 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
...
================================================================
  ...
  epistemic_p_u1_exp_r1:
    [critical] extraction_accumulation
        Evidence: evidence(extraction_delta,0,70,0.2,0.68)
...
--- Terminal State Predictions ---
  epistemic_p_u1_exp_r1 -> tangled_rope (confidence: low)
...
=== Logical Fingerprint: epistemic_p_u1_exp_r1 ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_perspectival_epistemic_p_u1_exp_r1
...
====================================================
Timeline:       1955 to 2025
Structural Pattern: stable
Confidence:     high

[META-LOGICAL AUDIT: ONTOLOGICAL FRAUD DETECTION]
  ! ALERT [informational]: perspectival_incoherence detected for epistemic_p_u1_exp_r1

[STRUCTURAL SIGNATURE ANALYSIS]
  epistemic_p_u1_exp_r1: false_ci_rope (confidence: high)
    → FALSE CI_ROPE signature for epistemic_p_u1_exp_r1: Appears to be rope (indexed_rope_classification) but fails 4 Boltzmann structural test(s): [boltzmann_non_compliant(1.0,0.25),scope_variant([snare,tangled_rope]),excess_above_floor(0.66),nonsensical_coupling(0.5)]. Coupling score=1.0. This constraint is "coordination-washed" — it hides extraction behind low metrics, distributed enforcement, or behavioral defaults.
    → Institutional beneficiary: career_driven_researchers
...
[MANDATROPHY GAP ANALYSIS]
  ...
  epistemic_p_u1_exp_r1 (snare vs tangled_rope):
    ! MANDATROPHY GAP: delta_chi = 0.38 (moderate)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 2 resolution scenario(s):

  ┌─ [intent_vs_structure] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Distinguishing between malicious intent and emergent structural incentives in p-hacking.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [omega_perspectival_epistemic_p_u1_exp_r1] CONCEPTUAL CLARIFICATION
  │  Constraint: epistemic_p_u1_exp_r1
  │  Gap: Constraint epistemic_p_u1_exp_r1 appears as snare to individuals but tangled_rope to institutions...
  │
  │  RESOLUTION STRATEGY:
  │  1. Map stakeholder perspectives:
  │     - Document how different actors perceive epistemic_p_u1_exp_r1
