...
[SCENARIO MANAGER] Loading: testsets/8k_tv_limit_2026.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: 8k_tv_limit_2026...
  [BRIDGE] Derived metric extractiveness = 0.1 for 8k_tv_limit_2026 from config default
  [BRIDGE] Derived metric suppression_requirement = 0.1 for 8k_tv_limit_2026 from config default
  [BRIDGE] Derived metric theater_ratio = 0.0 for 8k_tv_limit_2026 from config default
  [BRIDGE] Derived constraint_claim(8k_tv_limit_2026, rope) from computed analytical classification
  [FIXED] Imputed 24 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: 8k_tv_limit_2026

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: 8k_tv_limit_2026 (0-10)
...
=== Logical Fingerprint: 8k_tv_limit_2026 ===
...
[STRUCTURAL SIGNATURE ANALYSIS]
  8k_tv_limit_2026: constructed_low_extraction (confidence: low)
    → CONSTRUCTED LOW-EXTRACTION signature for 8k_tv_limit_2026: Enforcement present (suppression=0.10, resistance=0.50) but extraction is low (0.10). This is a rule-based coordination structure, not an extraction mechanism.

Aggregate Magnitude (Kappa) at Tn: 0.50

[PERSPECTIVAL GAP ANALYSIS]

  Constraint: 8k_tv_limit_2026
    Claimed Type: rope
    - Powerless: (no classification)
    - Moderate: (no classification)
    - Institutional: (no classification)
    - Analytical: (no classification)

[OMEGA GENERATION FROM PERSPECTIVAL GAPS: 8k_tv_limit_2026]
  No perspectival gaps detected requiring Ω tracking.

[OMEGA TRIAGE & PRIORITIZATION]

  [moderate] 1 omega(s):
    - omega_8k_content_production (empirical)
      Uncertainty over future native 8K content pipelines.

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 1 resolution scenario(s):

  ┌─ [omega_8k_content_production] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Uncertainty over future native 8K content pipelines.
  │
  │  RESOLUTION STRATEGY:
