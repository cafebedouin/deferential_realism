...
[SCENARIO MANAGER] Loading: testsets/subscription_economy_model_u4_exp_r2.pl...
[SCENARIO MANAGER] Performing Global Repair...

[REPAIR] Auditing vectors for: subscription_economy_model_u4_exp_r2...
  [FIXED] Imputed 32 missing vectors using domain priors

>>> INITIATING DR-AUDIT SUITE: subscription_economy_model_u4_exp_r2

--- [START] Data Verification ---
[OK] Ontology Schema matches.
Checking Interval: subscription_economy_model_u4_exp_r2 (2010-2025)
--- [END] Data Verification Complete ---
[OK] Verification passed.

--- PER-INDEX VALIDATION ---
  [INDEX OK] subscription_economy_model_u4_exp_r2 from context(agent_power(powerless),time_horizon(biographical),exit_options(trapped),spatial_scope(global)): declared=snare, computed=snare
  [INDEX OK] subscription_economy_model_u4_exp_r2 from context(agent_power(institutional),time_horizon(biographical),exit_options(arbitrage),spatial_scope(global)): declared=rope, computed=rope
  [INDEX MISMATCH] subscription_economy_model_u4_exp_r2 from context(agent_power(analytical),time_horizon(civilizational),exit_options(analytical),spatial_scope(global)): declared=tangled_rope, computed=snare
...
================================================================
  ...
  subscription_economy_model_u4_exp_r2:
    [critical] extraction_accumulation
        Evidence: evidence(extraction_delta,0,15,0.3,0.68)
...
--- Terminal State Predictions ---
  subscription_economy_model_u4_exp_r2 -> tangled_rope (confidence: low)
...
--- SCOPE EFFECT ANALYSIS ---
  Formula: χ = ε × f(d) × σ(S)
  subscription_economy_model_u4_exp_r2 (ε=0.68):
...
=== Logical Fingerprint: subscription_economy_model_u4_exp_r2 ===
...
--- ENRICHED OMEGA CONTEXT ---
  ...
  Omega: omega_extraction_blindness_subscription_economy_model_u4_exp_r2
...
--- CLASSIFICATION CONVERGENCE ---
    ...
    Confidence:       0.2824 (borderline)
    Rival Type:       snare (P=0.7176)
    Margin:           -0.4353
...
--- MAXENT SHADOW CLASSIFICATION ---
  ...
  Margin:        -0.4353
  Entropy:       0.3322
  Distribution:  snare: 0.718, tangled_rope: 0.282
...
[MANDATROPHY GAP ANALYSIS]
  ...
  subscription_economy_model_u4_exp_r2 (snare vs rope):
    ! MANDATROPHY GAP: delta_chi = 0.77 (high)

[OMEGA RESOLUTION SCENARIO GENERATION]
  Generated 3 resolution scenario(s):

  ┌─ [ownership_vs_access] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Ambiguity between necessary service cost and extractive rent-seeking in revoking ownership.
  │
  │  RESOLUTION STRATEGY:
  ...
  ┌─ [cancellation_friction_intent] EMPIRICAL DATA COLLECTION
  │  Constraint: unknown
  │  Gap: Whether cancellation difficulty is an intentional suppression tactic or incidental friction.
  │
  │  RESOLUTION STRATEGY:
  │  1. Design measurement protocol for unknown
  │  2. Collect data from N=30+ real-world instances
  ...
  ┌─ [omega_extraction_blindness_subscription_economy_model_u4_exp_r2] CONCEPTUAL CLARIFICATION
  │  Constraint: subscription_economy_model_u4_exp_r2
  │  Gap: Constraint subscription_economy_model_u4_exp_r2 appears extractive (Snare) to individuals but functional (Rope) to institutions...
  │
  ...
  │     - Who benefits from subscription_economy_model_u4_exp_r2?
  │     - Can you change/exit this constraint?
  │     - What would happen if you tried?
  │  2. Interview institutional actors (N=10+):
  │     - What function does subscription_economy_model_u4_exp_r2 serve?
