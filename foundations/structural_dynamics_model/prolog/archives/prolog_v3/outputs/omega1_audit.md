...
| naturalized_eps_at_or_below_045 | 10 | BaseEps <= 0.45 |
| naturalized_chi_at_or_above_040 | 39 | Chi >= 0.40 |
...
## Naturalized Impossibility at Analytical Context

**Claim**: The `naturalized` clause (drl_core.pl:314-318) can NEVER fire at the analytical/global context.
...
- **Confirmed**: The naturalized clause is structurally impossible at analytical context.
