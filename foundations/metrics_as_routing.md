...
**Origin:** This principle was first articulated in the UKE Protocol Framing Guide after Claude made the truth-frame error while auditing its own protocol outputs. The error was so consistent across AI models that it warranted foundational status. For UKE-specific application (confidence bins, IWBI formulas, fidelity thresholds, T1/T2 distinctions), see the original `uke_protocol_framing_guide.md`.
