...
1. Measure coupling score over time
2. If increase ≥ `coupling_drift_threshold` (0.10)
3. AND extraction rises
4. → **Coupling Drift detected**
...
coupling_drift(C, t_drift) :-
    coupling_score(C, t_before, Score_before),
    coupling_score(C, t_drift, Score_after),
    Delta is Score_after - Score_before,
    config:param(coupling_drift_threshold, Threshold),
    Delta >= Threshold,
    extractiveness_rising(C, t_before, t_drift).
```

**Parameters:**
- `coupling_drift_threshold` = 0.10
