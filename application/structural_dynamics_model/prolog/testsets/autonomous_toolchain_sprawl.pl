...
% High extraction (0.84) because the sprawl siphons the engineer's 
% cognitive labor into the maintenance of non-productive meta-layers.
...
domain_priors:theater_ratio(autonomous_toolchain_sprawl, 0.79). % Piton threshold (> 0.70) triggered by "Automation ROI" dashboards.
