...
% while transferring rewards (time, attention) to rule-breakers.
domain_priors:base_extractiveness(asshole_filter_2015, 0.75).

% Suppression: 0.60 (Moderate-High)
% Rationale: Decent behavior is suppressed because it becomes structurally 
% ineffective; polite alternatives become "invisible" to the enforcer.
domain_priors:suppression_score(asshole_filter_2015, 0.60).

% Enforcement: Emerges naturally when boundary enforcement fails.
...
constraint_victim(asshole_filter_2015, the_weak_enforcer).
...
/* --------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------
   WHO: individual_powerless - Respects rules but lacks power to enforce them.
...
test(multi_perspective_variance) :-
    constraint_indexing:constraint_classification(asshole_filter_2015, Type1, context(individual_powerless, immediate, trapped, local)),
