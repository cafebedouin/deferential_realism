...
domain_priors:base_extractiveness(ai_auditability_gap, 0.52). % Snare/Tangled threshold
domain_priors:suppression_score(ai_auditability_gap, 0.65).   % High: few non-AI alternatives
domain_priors:theater_ratio(ai_auditability_gap, 0.25).       % Low: The technical gap is real, not just theater.
...
test(perspectival_gap) :-
    ...
    constraint_indexing:constraint_classification(ai_auditability_gap, snare, context(agent_power(individual_powerless), _, _, _)),
