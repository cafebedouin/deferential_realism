...
/* --------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------
   WHO: individual_powerless - Works for a competitor like Uber or DoorDash.
...
test(multi_perspective_variance) :-
    ...
    constraint_indexing:constraint_classification(platform_cooperativism_governance, Type2, context(agent_power(individual_powerless), _, _, _)),
 ...
 *    'individual_powerless' agent. This highlights that even a beneficial 'Rope'
