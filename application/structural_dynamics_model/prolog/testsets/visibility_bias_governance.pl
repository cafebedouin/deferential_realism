...
domain_priors:base_extractiveness(visibility_bias_governance, 0.54). % High: Opportunity cost of ignored systemic risks.
domain_priors:suppression_score(visibility_bias_governance, 0.68).   % High: Alternatives are "invisible" and thus ignored.
domain_priors:theater_ratio(visibility_bias_governance, 0.78).       % High: Diagnostic of a Piton-prone system.
