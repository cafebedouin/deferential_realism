...
% Extraction is 0.48 (v3.4 Core: high-extraction trigger) to fund infrastructure.
domain_priors:base_extractiveness(artificial_scarcity_scaffold, 0.48). 
domain_priors:suppression_score(artificial_scarcity_scaffold, 0.75). % Choice is suppressed to force adoption.
domain_priors:theater_ratio(artificial_scarcity_scaffold, 0.20).    % Low theater; functional coordination.
