...
% High extraction (0.87) reflects the systematic siphoning of the subject's 
% primary cognitive autonomy to maintain platform engagement metrics.
...
domain_priors:theater_ratio(attention_as_bottleneck_resource, 0.84). % High theater: "Well-being" features that fail to reduce actual cognitive load.
